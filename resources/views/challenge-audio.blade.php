        ...
        <div class="row" style="margin-bottom: 50px">
            ...
            <div class="col-md-9">
                @if($challenge->hasBeenSent())
                    ...
                    <audio controls style="width: 100%;" autoplay preload = "auto" controlsList="nodownload">
                        <source src="{{ url($challenge->audio) }}" type="video/mp4">
                        <source src="{{ url($challenge->audio) }}" type="video/ogg">
